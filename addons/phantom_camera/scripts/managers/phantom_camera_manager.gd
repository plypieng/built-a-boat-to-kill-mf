...
# PCam Host
signal pcam_host_added_to_scene(pcam_host: Node)
signal pcam_host_removed_from_scene(pcam_host: Node)
...
# Viewfinder Signals
signal viewfinder_pcam_host_switch(pcam_host: Node)
...
var _phantom_camera_host_list: Array[Node]
var _phantom_camera_2d_list: Array[Node]
...
var _phantom_camera_tween_director_list: Array[Node]
...
var phantom_camera_hosts: Array[Node]:
	get:
		return _phantom_camera_host_list

var phantom_camera_2ds: Array[Node]:
	get:
...
var phantom_camera_tween_directors: Array[Node]:
	get:
...
func pcam_host_added(caller: Node) -> void:
	if caller != null and caller.is_class("PhantomCameraHost"):
...
func pcam_added(caller) -> void:
	if caller != null and caller.is_class("PhantomCamera2D"):
		_phantom_camera_2d_list.append(caller)
		pcam_added_to_scene.emit(caller)
	elif caller != null and caller.is_class("PhantomCamera3D"): ## Note: To support disable_3d export templates for 2D projects, this is purposely not strongly typed.
...
func pcam_tween_director_added(caller: Node) -> void:
	if caller != null and caller.is_class("PhantomCameraTweenDirector"):
...
func get_phantom_camera_hosts() -> Array[Node]:
	return _phantom_camera_host_list

func get_phantom_camera_2ds() -> Array[Node]:
	return _phantom_camera_2d_list
