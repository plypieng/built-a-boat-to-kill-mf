...
const SELF_SCRIPT_PATH := "res://addons/spatial_audio_extended/acoustic_material.gd"
...
static func _new_preset_material():
	return load(SELF_SCRIPT_PATH).new()


static func preset_generic():
	var m = _new_preset_material()
...
static func preset_acoustic_foam():
	var m = _new_preset_material()
